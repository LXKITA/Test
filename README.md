...
Весь план — исходный уровень, режим занятий, требования из вакансий, 60
ежедневных уроков, контрольные точки, итоговый проект и вопросы для
самопроверки — собран в одном документе:

**[Открыть «DevOps за 60 дней: ежедневный учебный план»](docs/curriculum.md)**

## Как учиться

1. Выполняйте дни из единого плана по порядку.
